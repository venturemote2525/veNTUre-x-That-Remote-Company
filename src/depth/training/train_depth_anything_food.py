...
# Add depth_anything to path (src/depth/depth_anything)
depth_anything_path = Path(__file__).resolve().parents[1] / "depth_anything"
...
class FoodDepthEstimator:
    ...
    def setup_logging(self):
        ...
        log_dir = Path(__file__).resolve().parents[1] / "training" / "logs" / f"depth_anything_{self.encoder}"
