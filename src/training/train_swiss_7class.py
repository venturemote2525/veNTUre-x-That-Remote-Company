...
# Add pytorch_mask_rcnn to path - adjust for new structure
maskrcnn_path = Path(__file__).parent.parent / "models" / "pytorch_mask_rcnn"
...
def main():
    ...
    default_data_root = Path(__file__).parent.parent.parent / "data" / "swiss_coco_7class"
